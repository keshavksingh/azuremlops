...
package_name = ["adlfs","applicationinsights","mlflow","azureml-mlflow","azure-ai-ml","mlflow[azureml]","azureml-core","azure-identity","delta-lake-reader[azure]","azureml-interpret","interpret-community"]
...
parser.add_argument("--AML_STORAGE_EXPERIMENT_DELTA_ROOT_PATH", type=str, help="AML_STORAGE_EXPERIMENT_DELTA_ROOT_PATH")
...
AML_STORAGE_EXPERIMENT_DELTA_ROOT_PATH = args.AML_STORAGE_EXPERIMENT_DELTA_ROOT_PATH
...
pandas_df = read_from_delta_as_pandas(SOURCE_STORAGE_ACCOUNT_VALUE,\
